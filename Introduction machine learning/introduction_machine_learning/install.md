# introduction machine learning guide installation
...
activate introduction_machine_learning
```
...
To move beyond notebook prototyping, all reusable code should go into the `introduction_machine_learning/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `introduction_machine_learning` folder and use the modules inside your notebooks :
...
```python
from introduction_machine_learning.utils.paths import data_dir
data_dir()
```
